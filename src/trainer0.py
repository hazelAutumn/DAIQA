# One output, for only distortion classification
import datetime
import itertools
import os
import random
...
from src.model import ModelDisOnly, create_model
from src.tools import train_model0, test_model0
...
def train_loop(rank, cfg):
    ...
    model = ModelDisOnly(cfg, net_arch, loss_f, rank)
