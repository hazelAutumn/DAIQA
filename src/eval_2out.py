...
from src.tools import train_model2, test_model2, test_model20
...
def test_loop(rank, cfg):
    ...
    test_loader, _ = create_dataloader(cfg, DataloaderMode.val, rank)
    ...
    try:
        test_model20(cfg, model, test_loader, writer)
        if is_logging_process():
